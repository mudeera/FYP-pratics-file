...
<head>
    ...
    <!--====== Title ======-->
    <title>Government Girls Degree College Skardu</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="images/all-icon/map.png" alt="icon"><span>Jamia Masjid Road Skardu</span></li>
                        ...
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                ...
                                <div class="cont">
                                    ...
                                    <span>05815 90246</span>
                                </div>
                            </div>
                            <div class="button float-left">
                                <a href="../backend/login.php" class="main-btn">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- row -->
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu">
                                            <li><a href="teachers.html">Arts</a></li>
                                            <li><a href="teachers-singel.html">Science</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#">Admission</a>
                                        <ul class="sub-menu">
                                            <li><a href="policy.html">Amission Policy</a></li>
                                            <li><a href="Scheme Of Studies.html">Scheme of Studies</a></li>
                                        </ul>
                                    </li>
                                    <!-- <li class="nav-item">
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/college/college.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/college/about\ college.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url(images/college/college\ 2.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
    ...
    <section id="about-part" class="pt-65">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50">
                        <h5>About us</h5>
                        <h2>Welcome to Girls Degree College Skardu</h2>
                    </div> <!-- section title -->
                    <div class="about-cont">
                        <p>Government Girls Degree College Skardu was started in 1989 from meager resources with the help of Boys Degree College Skardu. There were only six students who got admission inthe institution in 1989, a govt residence was used for this purpose. there was an acute shortage of educated ladies at that time. Only three faculty members were available, who were working in schools. The College were shifted to another Government building in 1996. The present building was constructed in 2004, it has an area of 30 canals.</p>
                        ...
                        <ul>
                            <li>
                                <div class="singel-event">
                                    <span><i class="fa fa-calendar"></i>14 August 2023</span>
                                    <a href="events-singel.html"><h4>Independence Day</h4></a>
                                    <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                    <span><i class="fa fa-map-marker"></i>Hall-1 Girls Degree College Skardu</span>
                                </div>
                            </li>
                            <li>
                                <div class="singel-event">
                                    <span><i class="fa fa-calendar"></i> 2 December 2018</span>
                                    <a href="events-singel.html"><h4>health Awairness seminor</h4></a>
                                    <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                    <span><i class="fa fa-map-marker"></i>>Hall-1 Girls Degree College Skardu</span>
                                </div>
                            </li>
        ...
        <div class="about-bg">
            <img src="./images/college/about college.jpg" alt="About">
        </div>
    </section>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6">
                        <div class="apply-cont apply-color-1">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta ducimus dolor, quo soluta consequatur possimus fuga itaque harum recusandae molestias, similique voluptates modi quos voluptatum minus exercitationem voluptate voluptas vel.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="apply-cont apply-color-2">
                            ...
                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque et nulla labore placeat? Ab ea sunt a laborum, accusamus sapiente odio nihil, ullam natus magni tempora soluta eligendi totam aperiam.</p>
                            <a href="#" class="main-btn">Apply Now</a>
                        </div> <!-- apply cont -->
                    </div> 
                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>BS Computer Science All subjects</h4></a>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn All Courses of intermediate Clases</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn How to Choose a right Career</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn basic javascirpt from start for beginner</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <span>(20 Reviws)</span>
                            <a href="courses-singel.html"><h4>Learn basic Python from start for beginner</h4></a>
                            <div class="course-teacher">
                                <div class="thum">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-last order-lg-first">
                    <div class="video text-lg-left text-center pt-50">
                        <a class="Video-popup" href="./images/video/video 2.mp4"><i class="fa fa-play"></i></a>
                    </div> <!-- row -->
                </div>
                            ...
                            <li>
                                <div class="singel-feature">
                                    ...
                                    <div class="cont">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores harum iure impedit rem nemo molestiae?</p>
                                    </div>
                                </div> <!-- singel feature -->
                            </li>
                            <li>
                                <div class="singel-feature">
                                    ...
                                    <div class="cont">
                                        <h4>Hostel System</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, numquam! Nesciunt doloremque sunt deserunt molestiae.</p>
                                    </div>
                                </div> <!-- singel feature -->
                            </li>
                            <li>
                                <div class="singel-feature">
                                    ...
                                    <div class="cont">
                                        <h4>Books & Library</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic sit minus ad commodi quibusdam nihil?</p>
                                    </div>
                                </div> <!-- singel feature -->
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="teachers-singel.html"><h6>Khadija Bano</h6></a>
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="teachers-singel.html"><h6>Salima Batool</h6></a>
                            ...
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    <div class="image rehana">
                                        <img src="images/teachers/t-3.jpg" alt="Teachers">
                                    </div>
                                    <div class="cont">
                                        <a href="teachers-singel.html"><h6>Rehana Haider</h6></a>
                                        <span>Pro chencelor</span>
                                    </div>
                                </div> <!-- singel teachers -->
                            </div>
                            <div class="col-sm-6">
                                <div class="singel-teachers mt-30 text-center">
                                    ...
                                    <div class="cont">
                                        <a href="teachers-singel.html"><h6>Dr.Abida Bano</h6></a>
        ...
        <div class="container">
            ...
            <div class="row testimonial-slied mt-40">
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="images/testimonial/sir raza.jpg" alt="Testimonial">
                            <!-- <div class="quote">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="images/testimonial/t-1 (2).jpg" alt="Testimonial">
                            <!-- <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div> -->
                        </div>
                        <div class="testimonial-cont">
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maiores animi nemo quia, aspernatur dignissimos repellendus sunt possimus incidunt! At, aspernatur.</p>
                            <h6>Sir Sajid</h6>
                            <span>Visiting Faculty</span>
                        </div>
                    </div> <!-- singel testimonial -->
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="images/testimonial/fmdt,tuj.jpg" alt="Testimonial">
                            <!-- <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div> -->
                        </div>
                        <div class="testimonial-cont">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, eius nisi? Rerum quidem a nulla impedit rem, cumque ratione et.</p>
                            <h6>Dr.Uzma Saleem</h6>
                            <span>Phd, Urdu</span>
                        </div>
                    </div> <!-- singel testimonial -->
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla id nesciunt ex pariatur maiores assumenda.</p>
                                </div>
                            </div>
                        </div> <!-- row -->
                    </div> <!-- singel news -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum nostrum deleniti hic dolor laudantium non.</p>
                                </div>
                            </div>
                        </div> <!-- row -->
                    </div> <!-- singel news -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about mt-40">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis animi itaque praesentium porro tenetur deleniti sapiente quia ullam fugit et.</p>
                            <ul class="mt-20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="shop.html"><i class="fa fa-angle-right"></i>Admission</a></li>
                        ...
                        <div class="footer-address mt-40">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="cont">
                                        <p>Girls College Jamia Masjid Road Skardu</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
        ...
        <div class="footer-copyright pt-10 pb-25">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="copyright text-md-right text-center pt-15" style="color: #FFF;">
                           All Rights Reserved @Girls College Skardu
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
